...
app.model({ namespace: 'list', ...(require('/Users/qfl/Desktop/项目/Ant design_projecct/Ant-Design-Pro-/src/models/list.js').default) });
...
app.model({ namespace: 'project', ...(require('/Users/qfl/Desktop/项目/Ant design_projecct/Ant-Design-Pro-/src/models/project.js').default) });
...
app.model({ namespace: 'user', ...(require('/Users/qfl/Desktop/项目/Ant design_projecct/Ant-Design-Pro-/src/models/user.js').default) });
